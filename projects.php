...
<body>
	...
	<section class="projects_listing">	
		<div class="background-image">
			<img src="./assets/images/project-page-bg.jpg" alt="project backgorund image">
		</div>
		<div class="container">			
			<div class="row justify-content-md-center">
				<div class="col-md-12 text-center">
					<ul class="work_tab project_filter" id="work_tab"> </ul>
					<div class="clear"></div> 
				</div>	
				<!--
				<div class="col-md-12" data-scrollreveal="enter top over 1.5s">
					<div class="main_title white text-center">
						<h2 class="orange"> Commercial </h2> <br />
					</div>
				</div>	
				-->				
				<div class="clear"></div>				
				<div class="col-md-12">
					<div class="portfolio-list d-flex flex-wrap" id="project_list"></div>
				</div>	<!-- -->	
			</div>	
		</div>
	</section>
